...
func TestComputeStreak(t *testing.T) {
	...
	t.Run("should return zero when contributions map is empty", func(t *testing.T) {
		// given
		contributions := map[string]int{}

		// when
		result := computeStreak(contributions)

		// then
		assert.Equal(t, 0, result)
	})

	t.Run("should return one for a single day", func(t *testing.T) {
		// given
		contributions := map[string]int{
			"2026-03-25": 5,
		}
	...
	t.Run("should count consecutive days correctly", func(t *testing.T) {
		// given
		contributions := map[string]int{
			"2026-03-23": 2,
			"2026-03-24": 3,
	...
	t.Run("should find the longest streak when there are gaps", func(t *testing.T) {
		// given
		contributions := map[string]int{
			"2026-03-20": 1,
			"2026-03-21": 2,
	...
	t.Run("should ignore days with zero contributions", func(t *testing.T) {
		// given
		contributions := map[string]int{
			"2026-03-24": 0,
			"2026-03-25": 5,
